...
<p>Consider using the <a href="npm-deprecate.html"><code>deprecate</code></a> command instead, if your intent is to encourage users to upgrade, or if you no longer want to maintain a package.</p>
<h3 id="description">Description</h3>
<p>This removes a package version from the registry, deleting its entry and removing the tarball.</p>
<p>The npm registry will return an error if you are not <a href="npm-adduser.html">logged in</a>.</p>
...
<li><a href="npm-adduser.html">npm login</a></li>
</ul></div>
