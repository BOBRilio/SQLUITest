...
<p>If you have two-factor authentication enabled with <code>auth-and-writes</code> (see <a href="npm-profile.html"><code>npm-profile</code></a>) then you'll need to go through a second factor flow when changing ownership or include an otp on the command line with <code>--otp</code>.</p>
