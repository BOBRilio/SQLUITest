...
<li><code>package-lock.json</code> (use <a href="npm-shrinkwrap-json.html"><code>npm-shrinkwrap.json</code></a> if you wish it to be published)</li>
...
Published packages may dictate their resolutions by pinning dependencies or using an <a href="npm-shrinkwrap-json.html"><code>npm-shrinkwrap.json</code></a> file.</p>
