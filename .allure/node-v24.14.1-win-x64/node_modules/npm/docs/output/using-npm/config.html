...
However, please note that inside <a href="scripts.html"><code>scripts</code></a> npm will set its own environment variables and Node will prefer those lowercase versions over any uppercase ones that you might set.
...
<p>The location of npm's log directory. See <a href="logging.html"><code>npm logging</code></a>
...
<li><a href="scripts.html">npm scripts</a></li>
